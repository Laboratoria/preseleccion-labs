...
export default function createTributePageTests() {
  ...
  describe('#Tribute Page tests', function () {
    ...
    describe('#Interactivity', function () {
      ...
      it(`My tribute page should have a button to switch between themes,
      with corresponding id="theme-switcher".`, function () {
        assert.isNotNull(document.getElementById('theme-switcher'));
        assert(
          document.querySelectorAll('button#theme-switcher').length,
          'element with id="theme-switcher" must be a button'
        );
      });
